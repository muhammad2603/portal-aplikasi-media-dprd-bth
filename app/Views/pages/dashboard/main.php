...
<body class="grid grid-cols-1 lg:grid-cols-12 min-h-screen">
    <aside class="fixed lg:sticky top-0 translate-x-[-100%] lg:translate-x-0 h-screen xl:h-fit lg:col-span-3 xl:col-span-2 bg-white border-r border-solid border-gray-200 z-[9999999] overflow-y-auto">
        <div class="nav-overlay hidden absolute top-0 left-0 w-screen h-screen bg-black/35 opacity-0 invisible z-[-1]"></div>
        <div class="top-aside pt-6 pb-4 px-6 flex gap-4 tracking-wider">
            <div class="title">
        ...
        <div class="mores-nav p-4 flex flex-col gap-2">
            <a href="/dashboard/pengaturan" class="pengaturan font-text active p-3 flex gap-1.5 text-gray-500/90 rounded-lg transition duration-150 ease-in hover:bg-gray-200 focus:outline-none focus:bg-gray-200" aria-label="Kunjungi halaman pengaturan">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <a href="/dashboard/logout" class="logout active font-text p-3 flex gap-1.5 text-red-500 rounded-lg transition duration-150 ease-in hover:bg-red-100 focus:outline-none focus:bg-red-100" aria-label="Keluar">
    ...
    <main class="flex flex-col h-screen lg:col-span-9 xl:col-span-10 bg-primary overflow-hidden">
        <header class="shrink-0 sticky top-0 py-8 md:py-5 px-7 flex items-center justify-between gap-6 sm:gap-0 bg-white border-b border-solid border-gray-200 shadow-sm z-10">
            <div class="start-header flex items-center gap-4 lg:gap-0">
            ...
            <aside class="flex items-center gap-5">
                <div class="notification-wrapper relative">
                    ...
                    <div class="notifications hidden absolute top-16 sm:top-13 md:top-11 lg:top-14 xl:top-11 right-0 bg-white border border-solid border-gray-200 shadow-md rounded-lg overflow-hidden">
                        <div class="notification-header p-4 w-96 flex flex-col border-b border-solid border-gray-200">
                            <h2 class="text-lg">Notifikasi</h2>
                            <p class="text-xs text-gray-500/90 tracking-wider">2 notifikasi belum dibaca</p>
                        </div>
                        <div class="notification-message min-h-96 max-h-96 2xl:min-h-[65vh] 2xl:max-h-[65vh] flex flex-col overflow-y-auto">
