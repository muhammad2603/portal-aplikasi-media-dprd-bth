...
<body class="grid grid-cols-1 lg:grid-cols-12 min-h-screen">
    <aside class="fixed lg:sticky top-0 translate-x-[-100%] lg:translate-x-0 h-screen xl:h-fit lg:col-span-3 xl:col-span-2 border-r border-solid border-gray-200 z-[9999999]">
        <div class="nav-overlay lg:hidden absolute top-0 left-0 w-screen h-screen bg-black/35 opacity-0 invisible z-[-1]"></div>
        ...
        <nav class="bg-white scrollbar-custom p-4 flex flex-col gap-2 min-h-[230px] max-h-[230px] overflow-y-auto border-b border-solid border-gray-200">
        ...
        <div class="mores-nav bg-white p-4 h-full lg:h-auto flex flex-col gap-2">
    ...
    <main class="lg:col-span-9 xl:col-span-10 bg-primary">
