...
<body class="grid grid-cols-1 sm:grid-cols-12 min-h-screen">
    <aside class="fixed sm:block sm:sticky top-0 h-screen sm:h-fit sm:col-span-2 bg-white border-r border-solid border-gray-200 z-[9999999]">
        <div class="top-aside pt-6 pb-4 px-6 tracking-wider">
        ...
        <nav class="p-4 flex flex-col gap-2 min-h-[230px] max-h-[230px] overflow-y-auto border-b border-solid border-gray-200">
