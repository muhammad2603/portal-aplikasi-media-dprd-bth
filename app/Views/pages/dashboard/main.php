    ...
    <aside class="fixed lg:sticky top-0 translate-x-[-100%] lg:translate-x-0 w-screen lg:w-full lg:col-span-3 xl:col-span-2 border-r border-solid border-gray-200 z-[9999999]">
        ...
        <div class="nav-container scrollbar-custom relative lg:w-full w-fit h-screen bg-white z-10 overflow-y-auto">
            ...
            <nav class="scrollbar-custom p-4 flex flex-col gap-2 min-h-[230px] max-h-[230px] overflow-y-auto border-b border-solid border-gray-200">
                <a href="<?= $current_nav === 'Dashboard' ? 'javascript:void(0)' : '/dashboard' ?>" class="beranda font-text text-sm p-3 flex items-center font-semibold gap-1.5 rounded-lg <?= $current_nav === 'Dashboard' ? 'bg-blue-600 text-white' : 'text-gray-500/90 transition duration-150 ease-in hover:bg-gray-200 focus:outline-none focus:bg-gray-200' ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
