...
<section class="grid grid-cols-1 lg:grid-cols-9 gap-6">
    ...
    <aside class="lg:col-span-5 xl:col-span-6 h-fit py-10 md:py-5 px-7 bg-white rounded-lg shadow-md">
        ...
        <div class="legend flex justify-between items-center">
            <div class="title">
                <h2 class="text-lg">Pengajuan Terbaru</h2>
                <p class="text-sm text-gray-500/90">Daftar pengajuan baru-baru ini</p>
            </div>
            ...
            <article class="py-5 px-4 bg-primary rounded-md shadow-sm">
                ...
                <div class="info mt-2 flex gap-3">
                    <span class="py-1 px-3 w-fit flex items-center gap-1 bg-cyan-100/80 font-semibold text-cyan-600 text-xs rounded-full">
                        ...
                        <span class="font-text">fattahillah</span>
                    </span>
            ...
            <article class="py-5 px-4 bg-primary rounded-md shadow-sm">
                ...
                <div class="info mt-2 flex gap-3">
                    <span class="py-1 px-3 w-fit flex items-center gap-1 bg-cyan-100/80 font-semibold text-cyan-600 text-xs rounded-full">
                        ...
                        <span class="font-text">john_doe</span>
                    </span>
                    <span class="flex items-center gap-1 text-gray-500/90">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0M12 12.75h.008v.008H12v-.008Z" />
            ...
            <article class="py-5 px-4 bg-primary rounded-md shadow-sm">
                ...
                <div class="info mt-2 flex gap-3">
                    <span class="py-1 px-3 w-fit flex items-center gap-1 bg-cyan-100/80 font-semibold text-cyan-600 text-xs rounded-full">
                        ...
                        <span class="font-text">jane_doe</span>
                    </span>
                    <span class="flex items-center gap-1 text-gray-500/90">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0M12 12.75h.008v.008H12v-.008Z" />
            ...
            <article class="py-5 px-4 bg-primary rounded-md shadow-sm">
                ...
                <div class="info mt-2 flex gap-3">
                    <span class="py-1 px-3 w-fit flex items-center gap-1 bg-cyan-100/80 font-semibold text-cyan-600 text-xs rounded-full">
                        ...
                        <span class="font-text">budi</span>
                    </span>
                    <span class="flex items-center gap-1 text-gray-500/90">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0M12 12.75h.008v.008H12v-.008Z" />
    ...
    <div class="activities mt-8 flex flex-col gap-4">
        <div class="flex gap-3.5">
            ...
            <div class="flex flex-col gap-0.5">
                ...
                <p class="text-sm text-gray-500/90">Pengajuan "Liputan Pemilu 2026" telah Anda Setujui</p>
        ...
        <div class="flex gap-3.5">
            ...
            <div class="flex flex-col gap-0.5">
                ...
                <p class="text-sm text-gray-500/90">Pengajuan "Festival Budaya Nusantara" telah Anda tolak</p>
                <span class="mt-1 flex gap-1 text-gray-500/90 text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
        ...
        <div class="flex gap-3.5">
            ...
            <div class="flex flex-col gap-0.5">
                ...
                <p class="text-sm text-gray-500/90">Pengajuan "Dewan Dorong Pemda dan APH Perkuat Pengawasan PETI" telah Anda tandai sebagai perbaikan.</p>
                <p class="text-sm text-gray-500/90">Komentar Anda: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Hic magni labore sit voluptate. Nulla iure similique earum minus iste fugit."</p>
                <span class="mt-1 flex gap-1 text-gray-500/90 text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
        ...
        <!-- @note: dibawah ini adalah aktivitas yang dilakukan oleh Admin lain -->
        <div class="flex gap-3.5">
            <span class="py-1.5 px-1.5 h-fit bg-gray-200/60 text-green-600 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            ...
            <div class="flex flex-col gap-0.5">
                <h3 class="text-base">Pengajuan disetujui</h3>
                <p class="text-sm text-gray-500/90">Pengajuan "Liputan Pemilu 2027" telah disetujui oleh Admin Andi</p>
                <span class="mt-1 flex gap-1 text-gray-500/90 text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
        ...
        <div class="flex gap-3.5">
            ...
            <div class="flex flex-col gap-0.5">
                <h3 class="text-base">Perbaikan pengajuan</h3>
                <p class="text-sm text-gray-500/90">Pengajuan "Dewan Dorong Pemda dan APH Perkuat Pengawasan PETI" telah ditandai sebagai perbaikan oleh Admin iil.</p>
                <p class="text-sm text-gray-500/90">Komentar: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Hic magni labore sit voluptate. Nulla iure similique earum minus iste fugit."</p>
                <span class="mt-1 flex gap-1 text-gray-500/90 text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
        ...
        <div class="flex gap-3.5">
            ...
            <div class="flex flex-col gap-0.5">
                <h3 class="text-base">Pengajuan ditolak</h3>
                <p class="text-sm text-gray-500/90">Pengajuan "Festival Budaya Nusantara" telah ditolak oleh Admin Andi</p>
                <span class="mt-1 flex gap-1 text-gray-500/90 text-xs">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
