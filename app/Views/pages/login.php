            ...
            <div class="form-login mt-5 flex flex-col gap-5 md:gap-4">
                <div class="input-email flex flex-col gap-1.5 text-sm">
                    ...
                    <div class="input relative text-gray-500/90">
                        ...
                        <input type="email" id="email" class="py-2.5 px-10 w-full bg-primary border border-solid border-gray-500/90 rounded-md focus:outline-none" placeholder="nama_email@gmail.com" aria-label="Masukkan Email" autocomplete="email" />
                    </div>
                </div>
                <div class="input-password flex flex-col gap-1.5 text-sm">
                    ...
                    <div class="input relative text-gray-500/90">
                        ...
                        <input type="password" id="password" class="py-2.5 px-10 w-full bg-primary border border-solid border-gray-500/90 rounded-md focus:outline-none" placeholder="Kata Sandi" aria-label="Masukkan Kata Sandi" autocomplete="off" />
                    </div>
                </div>
