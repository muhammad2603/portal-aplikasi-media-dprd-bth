<nav class="mt-8 flex flex-col gap-4">
    ...
    <?php endif ?>
    <a href="/dashboard/riwayat-pengajuan" class="py-3.5 px-3 flex justify-center md:justify-start items-center gap-1.5 rounded-md transition duration-150 <?= session()->get('role') === 'Admin' ? 'text-white bg-blue-500 hover:bg-blue-600' : 'hover:bg-primary border border-solid border-gray-300' ?>">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
